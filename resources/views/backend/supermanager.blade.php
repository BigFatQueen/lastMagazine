         ...
         <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
               <div class="row align-items-center">
                  <div class="col-8">
                     <h3 class="mb-0">Marketing Manager</h3>
                  </div>
            ...
            <div class="card-body">
               <form id="form-add"  method="post" enctype="mutipart/form-data">
                  <!-- accunt createing -->
...
<x-slot name="script">
  <script>
    $(document).ready(function(){
      ...
      $('#smtable').on('click','.btn-Delete',function(){
        var id=$(this).data('id');
        var url="supermanagerDelete/"+id;
      ...
      $('#smtable').on('click','.btn-Edit',function(){
        $('#add-form').hide();
        $('#edit-form').show();
      ...
      $('#form-edit').submit(function(e){
         ...
         // console.log(id);
            ...
            var url="{{route('supermanagerUpdate',':id')}}";
