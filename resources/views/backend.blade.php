...
<html>
   <head>
      ...
      <link href="{{asset('KMDtemplate/css/style.css')}}" rel="stylesheet">
   </head>
   <body class="app">
      <div id="loader">
         <div class="spinner"></div>
      </div>
      <script type="8634ecb3abb07036cb2b9cb4-text/javascript">window.addEventListener('load', () => {
                              ...
                              <div class="">
                                 <!-- <div class="logo">
                                    <script type="text/javascript" style="display:none">
                                       //<![CDATA[
                                       window.__mirage2 = {petok:"18278b7d8a0cf8e7dc441330ec99fd6bfd96b184-1599194816-86400"};
                                       //]]>
                                    </script>
                                    <script type="text/javascript" src="https://ajax.cloudflare.com/cdn-cgi/scripts/04b3eb47/cloudflare-static/mirage2.min.js"></script>
                                    <img data-cfsrc="image/logo.png" alt="" style="display:none;visibility:hidden;">
                                    <noscript><img src="image/logo.png" alt=""></noscript>
                                 </div> -->
                                 <img src="image/logo.png" width="83%" height="30%" alt="">
                              </div>
                              <div class="peer peer-greed">
                                 <h5 class="lh-1 mB-0 text-dark">Adminator</h5>
                              </div>
                           </div>
                        </a>
                     </div>
                           ...
                           <li>
                              <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                                 <li>
                                    <a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                       <div class="peer mR-15">
                                          <img class="w-3r bdrs-50p" data-cfsrc="https://randomuser.me/api/portraits/men/1.jpg" alt="" style="display:none;visibility:hidden;">
                                          <noscript><img class="w-3r bdrs-50p" src="https://randomuser.me/api/portraits/men/1.jpg" alt=""></noscript>
                                       </div>
                                       <div class="peer peer-greed">
                                 ...
                                 <li>
                                    <a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                       <div class="peer mR-15">
                                          <img class="w-3r bdrs-50p" data-cfsrc="https://randomuser.me/api/portraits/men/2.jpg" alt="" style="display:none;visibility:hidden;">
                                          <noscript><img class="w-3r bdrs-50p" src="https://randomuser.me/api/portraits/men/2.jpg" alt=""></noscript>
                                       </div>
                                       <div class="peer peer-greed">
                                 ...
                                 <li>
                                    <a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                       <div class="peer mR-15">
                                          <img class="w-3r bdrs-50p" data-cfsrc="https://randomuser.me/api/portraits/men/3.jpg" alt="" style="display:none;visibility:hidden;">
                                          <noscript><img class="w-3r bdrs-50p" src="https://randomuser.me/api/portraits/men/3.jpg" alt=""></noscript>
                                       </div>
                                       <div class="peer peer-greed">
                     ...
                     <li class="dropdown">
                        <a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
                           <div class="peer mR-10">
                              <img class="w-2r bdrs-50p" data-cfsrc="https://randomuser.me/api/portraits/men/10.jpg" alt="" style="display:none;visibility:hidden;">
                              <noscript><img class="w-2r bdrs-50p" src="https://randomuser.me/api/portraits/men/10.jpg" alt=""></noscript>
                           </div>
                              ...
                              <div class="layer w-100">
                                 <div class="bgc-grey-200 p-20 gapY-15">
                                    <div class="peers fxw-nw">
                                       <div class="peer mR-20">
                                          <img class="w-2r bdrs-50p" data-cfsrc="https://randomuser.me/api/portraits/men/11.jpg" alt="" style="display:none;visibility:hidden;">
                                          <noscript><img class="w-2r bdrs-50p" src="https://randomuser.me/api/portraits/men/11.jpg" alt=""></noscript>
                                       </div>
                                       <div class="peer peer-greed">
                                    ...
                                    <div class="peers fxw-nw ai-fe">
                                       <div class="peer ord-1 mL-20">
                                          <img class="w-2r bdrs-50p" data-cfsrc="https://randomuser.me/api/portraits/men/12.jpg" alt="" style="display:none;visibility:hidden;">
                                          <noscript><img class="w-2r bdrs-50p" src="https://randomuser.me/api/portraits/men/12.jpg" alt=""></noscript>
                                       </div>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js" integrity="sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8shuf57BaghqFfPlYxofvL8/KUEfYiJOMMV+rV" crossorigin="anonymous"></script>
               <script async src="https://www.googletagmanager.com/gtag/js?id=UA-23581568-13" type="8634ecb3abb07036cb2b9cb4-text/javascript"></script>
               <script type="8634ecb3abb07036cb2b9cb4-text/javascript">
      ...
      <script type="8634ecb3abb07036cb2b9cb4-text/javascript" src="{{asset('KMDtemplate/js/vendor.js')}}"></script><script type="8634ecb3abb07036cb2b9cb4-text/javascript" src="{{asset('KMDtemplate/js/bundle.js')}}"></script><script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="8634ecb3abb07036cb2b9cb4-|49" defer=""></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"5cd51c4eec4917ab","version":"2020.7.0","si":10}'></script>
   </body>
</html>